...
def load_patient_images(patient_id, base_dir=None, wildcard="*.*", exclude_wildcards=[]):
    ...
    # 找到从step1_preprocess_luna16_3.py  process_images(delete_existing=False, only_process_patient=only_process_patient)这个函数制作的CT图像
    ...
    return res   #这里得到mhd所对应的原始CT图像的数组
